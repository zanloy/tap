class TicketsController < ApplicationController
  ...
  def ticket_params
    params.require(:ticket).permit(:project_id, :priority, :title, :description, :assignee_id, attachments_attributes: [:id, :name, :file, :_destroy], purchases_attributes: [:id, :name, :url, :quantity, :cost, :_destroy])
  end
end
